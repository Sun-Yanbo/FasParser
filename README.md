# FasParser2
#### A package for batch manipulating sequence data on Windows ####
...
**Sun Yan-Bo** FasParser2: a graphical platform for manipulating biological sequences. ***Under review***
